...
ActiveRecord::Schema[7.0].define(version: 2024_10_17_112930) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.index ["tierlist_id"], name: "index_comments_on_tierlist_id"
  ...
  create_table "tierlists", force: :cascade do |t|
    ...
    t.index ["user_id", "created_at"], name: "index_tierlists_on_user_id_and_created_at"
  ...
  add_foreign_key "comments", "tierlists"
