class User < ApplicationRecord
  ...
  def self.create_guest_user
    ...
    user = new(email: guest_email, name: guest_name, password:, password_confirmation: password,
               activated: true, activated_at: Time.zone.now, deletion_time: 24.hours.from_now)
    if user.save
